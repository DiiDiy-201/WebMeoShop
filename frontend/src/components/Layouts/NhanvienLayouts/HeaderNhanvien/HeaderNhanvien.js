...
import { logoutNhanvien } from "../../../../actions/nhanvienActions";
                          ...
                          <ul className="d-flex align-items-center">
                            <li className="menu-item">
                              <div className="d-flex align-items-center">
                                <figure className="avatar avatar-nav">
                                  {nhanvien.avatar ? (
                                    <img
                                      src={
                                        nhanvien.avatar && nhanvien.avatar.url
                                      }
                                      alt={nhanvien && nhanvien.name}
                              ...
                              <ul className="submenu-home1">
                                ...
                                <li>
                                  <Link to="/nhanvien/profile">Thông tin</Link>
                                </li>
                                <Link
                                  to="/nhanvien/login"
