...
import {
  updatePasswordShipper,
  clearErrors,
} from "../../actions/shipperActions";
import { UPDATE_PASSWORD_SHIPPER_RESET } from "../../constants/shipperConstants";

import { useNavigate } from "react-router-dom";

const UpdatePasswordShipper = ({ history }) => {
  ...
  useEffect(() => {
    ...
    if (isUpdated) {
      ...
      dispatch({
        type: UPDATE_PASSWORD_SHIPPER_RESET,
      });
    }
  ...
  const submitHandler = (e) => {
    ...
    dispatch(updatePasswordShipper(formData));
  };
...
export default UpdatePasswordShipper;
