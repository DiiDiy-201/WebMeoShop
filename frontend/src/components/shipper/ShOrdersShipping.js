...
import {
  shipperallOrderShipping,
  clearErrors,
} from "../../actions/orderActions";

const ShOrdersShipping = () => {
  ...
  useEffect(() => {
    dispatch(shipperallOrderShipping());
  ...
  return (
    <Fragment>
      <MetaData title={"Shipper đơn đang giao"} />
      <div className="row">
        ...
        <div className="col-12 col-md-10">
          <Fragment>
            <h1 className="my-5">
              <i className="fa fa-arrow-circle-o-right"></i>Đơn hàng đang giao
            </h1>
...
export default ShOrdersShipping;
