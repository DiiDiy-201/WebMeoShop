...
import {
  nhanvienupdateCategory,
  nhanviengetCategoryDetails,
  clearErrors,
} from "../../actions/categoryActions";
import { UPDATE_CATEGORY_RESET } from "../../constants/categoryConstants";

const NvUpdateCategory = () => {
  ...
  useEffect(() => {
    if (category && category._id !== categoryId) {
      dispatch(nhanviengetCategoryDetails(categoryId));
    } else {
  ...
  const submitHandler = (e) => {
    ...
    dispatch(nhanvienupdateCategory(category._id, formData));
  };
  ...
  return (
    <Fragment>
      <MetaData title={"Nhân viên cập nhật danh mục"} />
      <div className="row">
...
export default NvUpdateCategory;
