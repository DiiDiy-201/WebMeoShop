...
const NvUpdateProduct = () => {
  ...
  const submitHandler = (e) => {
    ...
    dispatch(nhanvienupdateProduct(product._id, formData));
  };
  ...
  return (
    <Fragment>
      <MetaData title={"Nhân viên cập nhật sản phẩm"} />
      <div className="row">
...
export default NvUpdateProduct;
