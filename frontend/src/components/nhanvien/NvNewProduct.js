...
import { nhanviennewProduct, clearErrors } from "../../actions/productActions";
...
const NvNewProduct = () => {
  ...
  const submitHandler = (e) => {
    ...
    dispatch(nhanviennewProduct(formData));
  };
  ...
  return (
    <Fragment>
      <MetaData title={"Nhân viên thêm sản phẩm mới"} />
      <div className="row">
