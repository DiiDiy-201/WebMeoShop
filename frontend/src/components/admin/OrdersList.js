...
//moi
import OrdersProcessing from "./orderfilter/OrdersProcessing";
import OrdersCancel from "./orderfilter/OrdersCancel";
import OrdersProcessed from "./orderfilter/OrdersProcessed";
import OrdersShipping from "./orderfilter/OrdersShipping";
import OrdersShipped from "./orderfilter/OrdersShipped";
...
const OrdersList = () => {
  ...
  return (
    <Fragment>
      <MetaData title={"Admin quản lý đơn hàng"} />
      <div className="row">
