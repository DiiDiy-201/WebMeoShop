...
export const ALL_RELATEDPRODUCTS_REQUEST = "ALL_RELATEDPRODUCTS_REQUEST";
export const ALL_RELATEDPRODUCTS_SUCCESS = "ALL_RELATEDPRODUCTS_SUCCESS";
export const ALL_RELATEDPRODUCTS_FAIL = "ALL_RELATEDPRODUCTS_FAIL";
